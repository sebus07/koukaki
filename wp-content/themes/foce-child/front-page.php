...
<main id="primary" class="site-main">
    ...
    <section id="story" class="story">
        <h2><div class="hidden"><span class="premier" id="gliding-text"><div class="hidden"><span class="premier">L'</span><span class="deuxieme">histoire</span></div></div></h2>
...
<article id="characters">
  <div class="main-character title-container">
    <h3 class="pers"><div class="hidden"><span class="premier">les </span><span class="deuxieme">personnages</span></div></h3>
    <div class="swiper mySwiper">
      ...
      <div class="swiper-pagination"></div>
        ...
        <article id="place">
            <div>
                <h3><div class="hidden"><span class="premier">Le</span><span class="deuxieme"> Lieu</span></div></h3>
    ...
    <section id="studio">
        <h2><div class="hidden"><span class="premier">Studio</span><span class="deuxieme"> Koukaki</span></div></h2>
        <div>
